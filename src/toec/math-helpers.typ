...
#let calc-par(name, r1, r2, v1, v2, res, unit: "кОм") = {
  mathtype-mimic([
...
#let calc-seq(name, rs, vs, res, unit: "кОм") = {
  mathtype-mimic([
...
#let calc-div(left, top-sym, bot-sym, top-val, bot-val, res, unit: "мА") = {
  mathtype-mimic([
...
// Правило плеч
#let calc-shoulder(left, i-sym, r-top, r-bot, i-val, top-val, bot-val, res, unit: "мА") = {
  mathtype-mimic([
